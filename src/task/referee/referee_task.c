...
static int num=359;
static int supcolour;
static int spin_colour;//陀螺
static int fric_colour;//摩擦轮
static int cap_open_colour;//弹仓
static int Refresh_flag15=1;//准心更新标志位
static int Refresh_flag18=0;//准心更新标志位
static int Refresh_flag30=0;//准心更新标志位
