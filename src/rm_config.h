...
#define YAW_ANGLE_MAX 15//to be define
#endif

/* 云台pitch轴编码器归中值 */
#define CENTER_ECD_PITCH 2717
/* pitch轴最大仰角 */
#define PIT_ANGLE_MAX    45.0f
/* pitch轴最大俯角 */
#define PIT_ANGLE_MIN    30.0f
...
/* yaw轴电机PID参数 */
/* 速度环 */
#define YAW_KP_V             10000
#define YAW_KI_V             0.5
#define YAW_KD_V             10
#define YAW_INTEGRAL_V       0
#define YAW_MAX_V            30000
/* 角度环 */
#define YAW_KP_A             2
#define YAW_KI_A             0.001
#define YAW_KD_A             0.00f
#define YAW_INTEGRAL_A       0
#define YAW_MAX_A            25

/* PITCH轴电机PID参数 */
/* 速度环 */
#define PITCH_KP_V           5000
#define PITCH_KI_V           0.001
#define PITCH_KD_V           0
#define PITCH_INTEGRAL_V     1500
#define PITCH_MAX_V          30000
/* 角度环 */
#define PITCH_KP_A           0.35f
#define PITCH_KI_A           0.0f
#define PITCH_KD_A           0
#define PITCH_INTEGRAL_A     0.0f
#define PITCH_MAX_A          20
